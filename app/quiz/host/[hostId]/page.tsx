                  ...
                  <div className="space-y-1">
                    {result.playerAnswers.map((pa, idx) => {
                      ...
                      return (
                        <div
                          key={pa.contestantId}
                          className="p-2 bg-white rounded-sm border"
                        >
                ...
                questionResults.length < currentRevealQuestion && (
                  <div className="mb-4 sm:mb-6 p-3 sm:p-4 border-2 border-blue-500 rounded-lg bg-blue-50">
                    ...
                    <input
                      ...
                      className="w-full px-3 sm:px-4 py-2 sm:py-3 border border-gray-300 rounded-lg focus:outline-hidden focus:ring-2 focus:ring-blue-500 text-base sm:text-lg"
                      autoFocus
                    />
                  </div>
                )}
      ...
      <div className="flex items-center justify-between mb-4">
        ...
        <div className="flex items-center gap-2">
          <button
            ...
            className="px-3 py-1 bg-gray-200 rounded-sm hover:bg-gray-300 disabled:opacity-50 disabled:cursor-not-allowed"
          >
